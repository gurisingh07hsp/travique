...
const fields = [
  ...
  { name: "category",    label: "Category",         type: "select", icon: "💵",  placeholder: "", span: 1,  required: true },
...
const CATEGORIES = ['Destinations','Guide','Travel Tips','Experience','Wellness Travel']
        ...
        >
          ...
          <div className="modal-scroll flex-1 overflow-y-auto px-8 py-6">
            ...
            <div className="grid grid-cols-2 gap-4">
             ...
             <div>
            <label className="text-white/50 text-[11px] tracking-[0.12em] uppercase font-semibold mr-2 mb-2">Published</label>
